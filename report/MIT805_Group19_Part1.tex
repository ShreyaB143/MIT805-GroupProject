...
Data source: New York City Taxi and Limousine Commission (TLC) Trip Record Data (https://d37ci6vzurychx.cloudfront.net/trip-data)
Raw data size: >50 GB
Working data size: ~12 GB was downloaded for data cleaning
Processing data size: ~19 GB was the final cleaned data size
Publication date: Data published monthly by NYC TLC


\subsection{Dataset size}\label{AA}
xxx
...
Fig1 shows the trend in monthly trip volume during the specified time period. The general trend shows a decline in monthly trips, with a step change occurring in 2020. This decline to almost zero trips in 2020 can be attributed to the COVID-19 outbreak in the same year, which resulted in many countries imposing travel restrictions and most companies implementing work from home policies. Post COVID-19 saw an initial rise in monthly trips, which eventually stabilised around 4 million trips on average per month. This new average 
